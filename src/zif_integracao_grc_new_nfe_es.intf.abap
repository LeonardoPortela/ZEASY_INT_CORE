interface ZIF_INTEGRACAO_GRC_NEW_NFE_ES
  public .


  interfaces ZIF_INTEGRACAO_INJECT .

  class-data AT_IF_INTEGRACAO_GRC_EST_NFE type ref to ZIF_INTEGRACAO_GRC_NEW_NFE_ES .
  ...
  class-methods GET_INSTANCE
    returning
      value(R_IF_INTEGRACAO_GRC_EST_NFE) type ref to ZIF_INTEGRACAO_GRC_NEW_NFE_ES
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_DATA
    importing
