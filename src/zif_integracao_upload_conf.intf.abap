interface ZIF_INTEGRACAO_UPLOAD_CONF
  public .


  class-data AT_IF_INTEGRACAO_UPLOAD_CONF type ref to ZIF_INTEGRACAO_UPLOAD_CONF .
  ...
  class-methods GET_INSTANCE
    returning
      value(R_IF_INTEGRACAO_UPLOAD_CONF) type ref to ZIF_INTEGRACAO_UPLOAD_CONF
    raising
      ZCX_INTEGRACAO
      ZCX_ERROR .
  methods SET_DS_URL
    importing
      value(I_VIAGEM_ID) type ZDE_VIAGEM_ID optional
    returning
      value(R_IF_INTEGRACAO_UPLOAD_CONF) type ref to ZIF_INTEGRACAO_UPLOAD_CONF
    raising
      ZCX_INTEGRACAO .
