interface ZIF_INTEGRACAO_SIS
  ...
  class-data AT_IF_INTEGRACAO_SIS type ref to ZIF_INTEGRACAO_SIS .
  ...
  data AL_EMPRESAS type ZMME0006 .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_IF_INTEGRACAO_SIS) type ref to ZIF_INTEGRACAO_SIS
    raising
      ZCX_INTEGRACAO .
  methods GET_EMPRESAS_SIS
    importing
  ...
  methods SET_INDICADOR_SIS
    importing
      !INDICADOR type KAEP_COAC .
