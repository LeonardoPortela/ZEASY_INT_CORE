interface ZIF_INTEGRACAO_TX_CAMB_COUPA
  public .
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(R_IF_INTEGRACAO_TX_CAMB_COUPA) type ref to ZIF_INTEGRACAO_TX_CAMB_COUPA
    raising
      ZCX_INTEGRACAO .
