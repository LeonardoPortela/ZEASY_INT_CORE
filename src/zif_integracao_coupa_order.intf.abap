interface ZIF_INTEGRACAO_COUPA_ORDER
  public .


  class-data AT_IF_INTEGRACAO_ORDER type ref to ZIF_INTEGRACAO_COUPA_ORDER .
  ...
  data AT_PEDIDO_COMPRA_COUPA type ZSPEDIDO_COMPRA_COUPA .

  class-methods GET_INSTANCE
    returning
      value(R_IF_INTEGRACAO_ORDER) type ref to ZIF_INTEGRACAO_COUPA_ORDER
    raising
      ZCX_INTEGRACAO .
  methods SET_DS_DATA
    importing
