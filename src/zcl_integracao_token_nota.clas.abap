CLASS zcl_integracao_token_nota DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_integracao_token_nota .
...
CLASS ZCL_INTEGRACAO_TOKEN_NOTA IMPLEMENTATION.
  ...
  METHOD zif_integracao_token_nota~get_instance.

    IF zif_integracao_token_nota~at_if_integracao_token IS NOT BOUND.
      CREATE OBJECT zif_integracao_token_nota~at_if_integracao_token
        TYPE zcl_integracao_token_nota.
    ENDIF.

    r_if_integracao_token = zif_integracao_token_nota~at_if_integracao_token.

  ENDMETHOD.


  METHOD zif_integracao_token_nota~get_token.
    ...
    SELECT *
      ...
      WHERE service EQ 'TOKEN_NOTA_MOBMAN'.
    ...
    me->zif_integracao_token_nota~set_ds_url( ).
    me->zif_integracao_token_nota~set_send_msg( IMPORTING
  ...
  METHOD zif_integracao_token_nota~set_ds_url.
    ...
    READ TABLE lt_werbservice INTO wa_webservice WITH KEY service = 'TOKEN_NOTA_MOBMAN' BINARY SEARCH.
    IF sy-subrc IS INITIAL.
  ...
  METHOD zif_integracao_token_nota~set_send_msg.
